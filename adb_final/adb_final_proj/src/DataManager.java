 ...
 * 
 *         <h1>Data Manager</h1> 
 *         The DataManager class creates 1 sites for data replication. The initialization of sites with variables is conducted in the Site class 
...
public class DataManager {
	 ...
	 * @return If the site is not null (it is available), then return the value from that site. Otherwise, return -1.
	 * 
	 * NOT SURE IF THIS IS A GOOD IDEA FOR WHEN THE SITE IS DOWN... Still need to address logic on calling function for 
	 * instances where this method returns -1 
	 */
